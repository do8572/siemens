...
for i in range(4, 10):
    ...
    fm_model_2d.load_weights('models/2d_{}.h5'.format(i))
    test_x, test_y = df2xy(test[i-4], fm_model_2d)
    eval_2d = test[i-4].copy()
    ...
    fm_model_1d.load_weights('models/1d_{}.h5'.format(i))
    test_x, test_y = df2xy(test[i-4], fm_model_1d)
    eval_1d = test[i-4].copy()
    ...
    deepfm_model.load_weights('models/deepfm_{}.h5'.format(i))
    test_x, test_y = df2xy(test[i-4], deepfm_model)
    eval_deepfm = test[i-4].copy()
